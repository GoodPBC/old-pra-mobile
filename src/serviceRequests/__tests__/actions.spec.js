...
describe('Service Request Redux Actions', () => {
  ...
  it('should create UPDATE_PANHANDLING_RESPONSE_REQUEST and API_REQUEST actions', () => {
    const serviceRequest = { sr_number: 'sr_number' };
    const modifiedAt = moment();
    const response = {
    ...
    store.dispatch(actions.updatePanhandlingResponse(serviceRequest, response));
    expect(store.getActions()).toEqual(expectedActions);
  })
});